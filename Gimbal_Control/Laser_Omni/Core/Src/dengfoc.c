//
// Created by WorriedBottle on 2025/6/19.
//
...
void set_torque(float Uq, float angle_el) {
...
float get_electrical_angle(){
    return normalize_angle((float)(DIR * PP) * get_angle_without_track() - zero_electric_angle);
}
...
void DFOC_alignSensor(int _PP,int _DIR)
{
    ...
    set_torque(3, _3PI_2);
//    HAL_Delay(3000);
    zero_electric_angle = get_electrical_angle();
    set_torque(0, _3PI_2);
    sprintf(message, "zero_electric_angle is %d\r\n", zero_electric_angle);
